...
const Typography: React.FC<ControlPropsType> = ( props ) => {
	const {
		control: {
			setting,
			params: {
								...
								{ currentFont?.variants && (
									<div className="font-variant">
										...
										<SelectControl
											...
											options={
												currentFont.variants
													.filter( ( v: any ) => -1 === v.indexOf( 'italic' ) )
													.map( ( v: any ) => toWeight( v ) )
