...
$options = [
	'vite[header-social-links]'            => [
		...
		'default'     => vite( 'core' )->get_mod_defaults()['header-social-links'],
		'partial'     => [
	...
	'vite[header-social-icons-size]'       => [
		...
		'default'     => vite( 'core' )->get_mod_defaults()['header-social-icons-size'],
		'partial'     => [
			'selector'        => '.vite-header .vite-social',
			'render_callback' => function () {
				get_template_part( 'template-parts/builder-elements/socials', '', [ 'context' => 'header' ] );
	...
	'vite[header-social-icons-color-type]' => [
		...
		'default'     => vite( 'core' )->get_mod_defaults()['header-social-icons-color-type'],
		'partial'     => [
			'selector'        => '.vite-header .vite-social',
			'render_callback' => function () {
				get_template_part( 'template-parts/builder-elements/socials', '', [ 'context' => 'header' ] );
	...
	'vite[header-social-icons-colors]'     => [
		...
		'default'     => vite( 'core' )->get_mod_defaults()['header-social-icons-colors'],
		'input_attrs' => [
			'colors'    => [
				[
					'id'    => '--link-color',
