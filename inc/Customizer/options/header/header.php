...
$options = [
	'vite[header]'                    => [
		...
		'default'     => vite( 'core' )->get_theme_mod_defaults()['header'],
	...
	'vite[header-top-row-layout]'     => [
		...
		'default' => vite( 'core' )->get_theme_mod_defaults()['header-top-row-layout'],
		'choices' => [
	...
	'vite[header-top-row-height]'     => [
		...
		'default'     => vite( 'core' )->get_theme_mod_defaults()['header-top-row-height'],
		'input_attrs' => [
			'min'        => 0,
			'max'        => 400,
			'step'       => 1,
	...
	'vite[header-main-row-layout]'    => [
		...
		'type'    => 'vite-buttonset',
		'title'   => __( 'Layout', 'vite' ),
		'default' => vite( 'core' )->get_theme_mod_defaults()['header-main-row-layout'],
		'choices' => [
			'contained'  => __( 'Contained', 'vite' ),
			'full-width' => __( 'Full width', 'vite' ),
		],
	...
	'vite[header-main-row-height]'    => [
		...
		'type'        => 'vite-slider',
		'title'       => __( 'Height', 'vite' ),
		'default'     => vite( 'core' )->get_theme_mod_defaults()['header-main-row-height'],
		'input_attrs' => [
			'min'        => 0,
			'max'        => 400,
			'step'       => 1,
	...
	'vite[header-bottom-row-layout]'  => [
		...
		'type'    => 'vite-buttonset',
		'title'   => __( 'Layout', 'vite' ),
		'default' => vite( 'core' )->get_theme_mod_defaults()['header-bottom-row-layout'],
		'choices' => [
			'contained'  => __( 'Contained', 'vite' ),
			'full-width' => __( 'Full width', 'vite' ),
		],
	...
	'vite[header-bottom-row-height]'  => [
		...
		'type'        => 'vite-slider',
		'title'       => __( 'Height', 'vite' ),
		'default'     => vite( 'core' )->get_theme_mod_defaults()['header-bottom-row-height'],
		'input_attrs' => [
			'min'        => 0,
			'max'        => 400,
			'step'       => 1,
	...
	'vite[header-sticky]'             => [
		...
		'default'     => vite( 'core' )->get_theme_mod_defaults()['[header-sticky'] ?? false,
		'input_attrs' => [
			'separator' => true,
		],
	],
	'vite[header-sticky-row]'         => [
		...
		'default'   => vite( 'core' )->get_theme_mod_defaults()['header-sticky-row'],
		'choices'   => [
			'top'         => __( 'Top', 'vite' ),
			'main'        => __( 'Main', 'vite' ),
	...
	'vite[header-sticky-enable]'      => [
		...
		'default'     => vite( 'core' )->get_theme_mod_defaults()['header-sticky-enable'],
		'choices'     => [
	...
	'vite[header-transparent]'        => [
		...
		'default'     => vite( 'core' )->get_theme_mod_defaults()['[header-transparent'] ?? false,
		'input_attrs' => [
			'separator' => true,
		],
	],
	'vite[header-transparent-enable]' => [
		...
		'type'        => 'vite-buttonset',
		'title'       => __( 'Enable on', 'vite' ),
		'default'     => vite( 'core' )->get_theme_mod_defaults()['header-transparent-enable'],
		'choices'     => [
			'desktop' => __( 'Desktop', 'vite' ),
			'tablet'  => __( 'Tablet', 'vite' ),
			'mobile'  => __( 'Mobile', 'vite' ),
	...
	'vite[header-background]'         => [
		...
		'default'     => vite( 'core' )->get_theme_mod_defaults()['header-background'],
