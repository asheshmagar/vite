...
$options = [
	'vite[footer-social-links]'            => [
		...
		'default'     => vite( 'core' )->get_mod_defaults()['footer-social-links'],
		'partial'     => [
	...
	'vite[footer-social-icons-size]'       => [
		...
		'default'     => vite( 'core' )->get_mod_defaults()['footer-social-icons-size'],
		'partial'     => [
			'selector'        => '.vite-footer .vite-social',
			'render_callback' => function () {
				get_template_part( 'template-parts/builder-elements/socials', '', [ 'context' => 'footer' ] );
	...
	'vite[footer-social-icons-color-type]' => [
		...
		'default'     => vite( 'core' )->get_mod_defaults()['footer-social-icons-color-type'],
		'partial'     => [
			'selector'        => '.vite-footer .vite-social',
			'render_callback' => function () {
				get_template_part( 'template-parts/builder-elements/socials', '', [ 'context' => 'footer' ] );
	...
	'vite[footer-social-icons-colors]'     => [
		...
		'default'     => vite( 'core' )->get_mod_defaults()['footer-social-icons-colors'],
		'input_attrs' => [
			'colors'    => [
				[
					'id'    => '--link-color',
