...
$options = [
	'vite[scroll-to-top]'               => [
		...
		'default' => $core->get_mod_defaults()['scroll-to-top'],
		'partial' => [
	...
	'vite[scroll-to-top-position]'      => [
		...
		'default'     => $core->get_mod_defaults()['scroll-to-top-position'],
		'choices'     => [
			'left'  => __( 'Left', 'vite' ),
			'right' => __( 'Right', 'vite' ),
		],
	...
	'vite[scroll-to-top-edge-offset]'   => [
		...
		'default'     => $core->get_mod_defaults()['scroll-to-top-edge-offset'],
		'input_attrs' => [
			'units'      => [ 'px' ],
			'responsive' => true,
			'separator'  => true,
	...
	'vite[scroll-to-top-bottom-offset]' => [
		...
		'default'     => $core->get_mod_defaults()['scroll-to-top-bottom-offset'],
		'input_attrs' => [
			'units'      => [ 'px' ],
			'responsive' => true,
			'separator'  => true,
	...
	'vite[scroll-to-top-button-size]'   => [
		...
		'default'     => $core->get_mod_defaults()['scroll-to-top-button-size'],
		'input_attrs' => [
			'units'      => [ 'px', 'rem', 'em' ],
			'responsive' => true,
			'separator'  => true,
	...
	'vite[scroll-to-top-icon-size]'     => [
		...
		'default'     => $core->get_mod_defaults()['scroll-to-top-icon-size'],
		'input_attrs' => [
			'separator' => true,
		],
		'condition'   => [
	...
	'vite[scroll-to-top-border]'        => [
		...
		'default'     => $core->get_mod_defaults()['scroll-to-top-border'],
		'input_attrs' => [
			'separator' => true,
		],
		'condition'   => [
	...
	'vite[scroll-to-top-radius]'        => [
		...
		'default'     => $core->get_mod_defaults()['scroll-to-top-radius'],
		'input_attrs' => [
			'units'     => [ 'px', 'rem', 'em', '%' ],
			'separator' => true,
